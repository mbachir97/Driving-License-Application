...
using static DVLD_Bisness.clsTestType;

namespace DVLD.Tests
{
  

    public partial class NewSchudeldTest : UserControl
    {


        public NewSchudeldTest()
        {
            InitializeComponent();
        }
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            _LocalDrivingLicenseApplicationID = LocalDrivingLicenseApplicationID;
            _LocalDrivingLicenseApplication = clsLocalDrivingLicenseApplication.FindByLocalAppID(_LocalDrivingLicenseApplicationID);
            ...
            {
                lblRetakeAppFees.Text = clsApplicationType.Find((int)clsApplication.enApplicationType.enRetakeTest).ApplicationFees.ToString();
            ...
            lblTrial.Text = _LocalDrivingLicenseApplication.TotalTrialTestPerType(_TestTypeID).ToString();
        ...
        private bool _HandlePrviousTestConstraint()
        {
            ...
            switch (TestTypeID)
            {
                ...
                case clsTestType.enTestType.WrittenTest:
                    ...
                    if (!_LocalDrivingLicenseApplication.DoesPassTestType(clsTestType.enTestType.VissionTest))
                    {
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                Application.ApplicationTypeID = (int)clsApplication.enApplicationType.enRetakeTest;
                Application.ApplicationStatus = (int)clsApplication.enApplicationStatus.Complete;
                Application.LastStatusDate = DateTime.Now;
                Application.PaidFees = clsApplicationType.Find((int)clsApplication.enApplicationType.enRetakeTest).ApplicationFees;
